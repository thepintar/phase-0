...
// I had trouble passing the test adding the first child as an object. I had to get my mind around using the dot method rather than
// the bracket method (which also would have worked) from Ruby Hashes. Once I defined carson as a new object it was easy.
// How difficult was it to add and delete properties outside of the object itself?
// It was super easy once I hammered down the proper syntax. Its like an echo of the same type of exercise in Ruby, so its familiar at least.
// What did you learn about manipulating objects in this challenge?
// I learned that while its a lot like manipulating hashes, except I have a few more tools in using the dot method rather than the bracket method.
// //
//
//
//
